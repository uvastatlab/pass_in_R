...
An F test assesses whether _any_ of the predictors in a multiple regression model are useful in predicting the response. The null hypothesis is that all of the coefficients (except the intercept) are 0. Rejecting the null implies the model has some explanatory value, though it doesn't tell you how much. 
