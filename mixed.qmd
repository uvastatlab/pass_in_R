...
Now define our between and within group variance. Note that the simr package requires the between group variance be expressed as variance and the within group variance expressed as standard deviation
