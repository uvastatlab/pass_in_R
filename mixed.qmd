...
A sample size of 15 gets us to power over 0.80, and sample size of about 19 gets us to 0.90.
...
Next define our effects. We need to provide intercept and slope coefficients. The slope coefficient is the effect we will test. The intercept can be interpreted as the average number of bugs captured in the control trap. 

```{r}
b <- c(0, 3) # fixed intercept and slope
```
